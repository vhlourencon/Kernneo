...
public class GenericListInternalFrame<NEGOCIO extends Negocio, GENERICMODEL extends GenericModel> extends JInternalFrame
    {
                        ...
                        try {
                            Conexao.Executar(new Comando() {
                                ...
                                public void execute(Session session) throws Exception {
                                    getFormCadPanel().setModel((GENERICMODEL) getNegocio().obterPorId(modelSelecionado));
                                    setModoForm();
                            ...
                            JOptionPane.showMessageDialog(null, e1.getLocalizedMessage(), "ERRO", JOptionPane.ERROR_MESSAGE);
                        }
                        ;
                    }
        ...
        protected void acaoEditar() {
            try {
                ...
                eventoAcaoEditar(getFormCadPanel().getModel());
        ...
        public void setGenericFiltroPanel(GenericFiltroPanel<GENERICMODEL> genericFiltroPanel, GENERICMODEL filtroModel, boolean selecionado) {
