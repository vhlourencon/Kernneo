...
public class ObservacaoFormCadPanel extends GenericFormCadPanel<ObservacaoModel> {
    /**
     * 
     */
	...
	panel.setBorder(new TitledBorder(null, "Informa\u00E7\u00F5es de Observacao", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    @Override
    public ObservacaoModel getModel() {
    ...
    @Override
    public void setModel(ObservacaoModel model) {

	if (model == null) {
	    model = new ObservacaoModel();
	}
