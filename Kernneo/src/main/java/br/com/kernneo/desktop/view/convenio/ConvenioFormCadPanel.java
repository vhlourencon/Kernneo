...
public class ConvenioFormCadPanel extends GenericFormCadPanel<ConvenioModel> {
    /**
     * 
     */
	...
	panel.setBorder(new TitledBorder(null, "Informa\u00E7\u00F5es de Convênio", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    @Override
    public void setModel(ConvenioModel model) {
